...
- **ICRC Act 2005** · State PPP Laws · **NDPA 2023** · **NITDA** local content · **Permissive FOSS** licensing
- **Zero-trust security** · **In-country sovereign residency**
- Data provenance: every material figure tagged `[LIVE]` / `[DERIVED]` / `[GAP]`
